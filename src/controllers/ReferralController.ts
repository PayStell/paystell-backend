...
export class ReferralController {
  ...
  processReferralSignup = async (
    ...
    try {
      ...
      const referral = await this.referralService.processReferralSignup(
        referralCode,
        userId,
      );
  ...
  getUserReferrals = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      const result = await this.referralService.getUserReferrals(
        userId,
        page,
        limit,
      );
  ...
  getUserRewards = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      const result = await this.referralService.getUserRewards(
        userId,
        page,
        limit,
      );
  ...
  validateReferralCode = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      const referral = isValid
        ? await this.referralService.getReferralByCode(code)
        : null;
  ...
  processRewardPayment = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      const reward = await this.referralService.processRewardPayment(
        Number.parseInt(id),
        transactionHash,
      );
