...
export class ReferralProgramController {
  ...
  updateProgram = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      const { id } = req.params
      const program = await this.programService.updateProgram(Number.parseInt(id), req.body)
  ...
  getProgramById = async (req: Request, res: Response): Promise<void> => {
    try {
      const { id } = req.params
      const program = await this.programService.getProgramById(Number.parseInt(id))
  ...
  activateProgram = async (req: Request, res: Response): Promise<void> => {
    try {
      const { id } = req.params
      const program = await this.programService.activateProgram(Number.parseInt(id))
  ...
  deactivateProgram = async (req: Request, res: Response): Promise<void> => {
    try {
      const { id } = req.params
      const program = await this.programService.deactivateProgram(Number.parseInt(id))
